...
get_feature_paths() {
    ...
    # Split layout: the product spec lives under wiki/specs/<name>/ (FEATURE_DIR),
    # while all engineering artifacts (plan, research, design, contracts, tasks)
    # live under wiki/technical/<name>/ (TECH_DIR). The two trees share the same
    # <name> (basename of the resolved feature directory).
    local feature_name
    feature_name=$(basename "$feature_dir")
    local tech_dir="$repo_root/wiki/technical/$feature_name"
    ...
    printf 'IMPL_PLAN=%q\n' "$tech_dir/plan.md"
    printf 'TASKS=%q\n' "$tech_dir/tasks.md"
    printf 'RESEARCH=%q\n' "$tech_dir/research.md"
    printf 'DATA_MODEL=%q\n' "$tech_dir/data-model.md"
    printf 'QUICKSTART=%q\n' "$tech_dir/quickstart.md"
